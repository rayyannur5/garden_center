              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      'Tanaman',
                      style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w900, fontSize: 25),
                    ),
                  ),
                  Container(
                    child: Row(
                      ...
                      children: [
                        ...
                        ClipOval(
                          child: Material(
                            ...
                            child: Container(
                                height: 50, width: 50, child: IconButton(icon: Icon(Icons.search), onPressed: () {})),
                          ),
                        ),
                      ],
                    ),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  title: Text(name, style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700)),
                  subtitle: Text(desc, style: TextStyle(fontFamily: 'Poppins', fontSize: 12)),
                ),
              ),
              Container(
                child: IconButton(
